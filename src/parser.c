...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_apply, 2, .production_id = 4),
  [45] = {.entry = {.count = 1, .reusable = false}}, SHIFT(17),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_apply, 2, .production_id = 4),
  ...
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_neg, 2, .production_id = 3),
  [61] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_neg, 2, .production_id = 3),
  [63] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary, 3, .production_id = 5),
  [65] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary, 3, .production_id = 5),
  ...
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if, 6, .production_id = 6),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if, 6, .production_id = 6),
